...
Embeddings = torch.load(os.path.join(model.save_dir, 'Embedding.pt'))
model.netEM.load_state_dict(Embeddings)
...
for i, data in enumerate(dataset):
    ...
    code_list.append(model.latents.detach().cpu().numpy())
...
import pdb; pdb.set_trace()  # breakpoint f3b45baa //
